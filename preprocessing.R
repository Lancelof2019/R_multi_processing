...
TCGAanalyze_survival(survivalInfo, clusterCol = "hc", color = c("#33A02C","#1F78B4","#E31A1C","#AC4B1C","#FFD57E"), filename = paste0("./figure/surv_analysis/",cancer_type,"_survival_analysis01.pdf"), conf.int = F, width = 7, height = 7)

TCGAanalyze_survival(survivalInfo, clusterCol = "shortLetterCode", filename = paste0("./figure/surv_analysis/",cancer_type,"_survival_analysis_tumorType01.pdf"), conf.int = F, width = 7, height = 7)
